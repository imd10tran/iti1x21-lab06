...
2. À partir de ce dossier, compilez et exécutez TestL06.java:

### Sous Windows

```
javac -cp "junit-4.13.jar;hamcrest-core-1.3.jar;." TestL06.java
java -cp "junit-4.13.jar;hamcrest-core-1.3.jar;." TestL06
```
